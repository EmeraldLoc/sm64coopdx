...
SMLUA_EVENT_HOOK(HOOK_ON_TEXT_INPUT, HOOK_RETURN_NEVER, const char *text)
SMLUA_EVENT_HOOK(HOOK_ON_TEXT_EDITING, HOOK_RETURN_NEVER, const char *text, s32 start)
