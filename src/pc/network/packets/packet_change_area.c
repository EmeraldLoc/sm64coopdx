...
static void player_changed_area(struct NetworkPlayer *np, s16 courseNum, s16 actNum, s16 levelNum,
                                s16 areaIndex) {
...
void network_send_change_area(void) {
    ...
    if (gNetworkType == NT_SERVER) {
        player_changed_area(gNetworkPlayerLocal, gCurrCourseNum, gCurrActStarNum, gCurrLevelNum,
                            gCurrAreaIndex);
        return;
    }
