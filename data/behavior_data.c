...
const BehaviorScript bhvBitfsSinkingPlatforms[] = {
    ...
    SET_HOME(),
    CALL_NATIVE(bhv_bitfs_sinking_platform_init),
    BEGIN_LOOP(),
...
const BehaviorScript bhvBitfsSinkingCagePlatform[] = {
    ...
    CALL_NATIVE(bhv_bitfs_sinking_cage_platform_init),
    BEGIN_LOOP(),
...
const BehaviorScript bhvJrbSlidingBox[] = {
    ...
    SET_HOME(),
    CALL_NATIVE(bhv_jrb_sliding_box_init),
    BEGIN_LOOP(),
...
const BehaviorScript bhvShipPart3[] = {
    ...
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_HOME(),
    CALL_NATIVE(bhv_ship_part_3_init),
    BEGIN_LOOP(),
