...
static struct LuaObjectField sCharacterFields[LUA_CHARACTER_FIELD_COUNT] = {
    ...
    { "capEnemyDecalGfx",                   LVT_STRING,  offsetof(struct Character, capEnemyDecalGfx),                   false, LOT_NONE                                   },
    { "capEnemyGfx",                        LVT_STRING,  offsetof(struct Character, capEnemyGfx),                        false, LOT_NONE                                   },
