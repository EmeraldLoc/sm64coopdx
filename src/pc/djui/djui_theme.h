...
// unfortunately, autogen can't read a macro and then read an include header, which means
// we need to define the theme elements in both the inl file AND here. Quite unfortunate
// but it is what it is. Hopefully this can be solved later
