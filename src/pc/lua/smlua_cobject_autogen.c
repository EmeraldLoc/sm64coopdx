...
static struct LuaObjectField sCharacterFields[LUA_CHARACTER_FIELD_COUNT] = {
    ...
    { "capEnemyDecalGfx",                   LVT_STRING_P, offsetof(struct Character, capEnemyDecalGfx),                   true,  LOT_NONE                                   },
    { "capEnemyGfx",                        LVT_STRING_P, offsetof(struct Character, capEnemyGfx),                        true,  LOT_NONE                                   },
    ...
    { "torsoRotMult",                       LVT_F32,      offsetof(struct Character, torsoRotMult),                       false, LOT_NONE                                   },
    { "type",                               LVT_S32,      offsetof(struct Character, type),                               false, LOT_NONE                                   },
};
...
static struct LuaObjectField sPresetPaletteFields[LUA_PRESET_PALETTE_FIELD_COUNT] = {
    { "name",    LVT_STRING,  offsetof(struct PresetPalette, name),    true, LOT_NONE          },
