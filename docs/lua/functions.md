...
- smlua_gfx_utils.h
   ...
   - [gfx_shader_get_frame_pass_viewport_dimensions](functions-7.md#gfx_shader_get_frame_pass_viewport_dimensions)
   - [gfx_shader_set_frame_pass_viewport_dimensions](functions-7.md#gfx_shader_set_frame_pass_viewport_dimensions)
   - [gfx_shader_get_frame_pass_filter](functions-7.md#gfx_shader_get_frame_pass_filter)
   - [gfx_shader_set_frame_pass_filter](functions-7.md#gfx_shader_set_frame_pass_filter)
   - [gfx_shader_get_frame_pass_draw_world_geometry](functions-7.md#gfx_shader_get_frame_pass_draw_world_geometry)
   - [gfx_shader_set_frame_pass_draw_world_geometry](functions-7.md#gfx_shader_set_frame_pass_draw_world_geometry)
