...
SMLUA_EVENT_HOOK(HOOK_ON_VERTEX_SHADER_CREATE, HOOK_RETURN_ON_OUTPUT_SET, struct ColorCombiner *cc, OUTPUT const char **vertexShader)
SMLUA_EVENT_HOOK(HOOK_ON_FRAGMENT_SHADER_CREATE, HOOK_RETURN_ON_OUTPUT_SET, struct ColorCombiner *cc, OUTPUT const char **fragmentShader)
SMLUA_EVENT_HOOK(HOOK_ON_POST_PROCESS_VERTEX_SHADER_CREATE, HOOK_RETURN_ON_OUTPUT_SET, OUTPUT const char **vertexShader)
SMLUA_EVENT_HOOK(HOOK_ON_POST_PROCESS_FRAGMENT_SHADER_CREATE, HOOK_RETURN_ON_OUTPUT_SET, OUTPUT const char **fragmentShader)
SMLUA_EVENT_HOOK(HOOK_BEFORE_DRAW_GEOMETRY, HOOK_RETURN_NEVER)
SMLUA_EVENT_HOOK(HOOK_ON_DRAW_GEOMETRY, HOOK_RETURN_NEVER)
SMLUA_EVENT_HOOK(HOOK_ON_SET_SHADER_UNIFORMS, HOOK_RETURN_NEVER)
SMLUA_EVENT_HOOK(HOOK_ON_SET_SHADER_PROGRAM, HOOK_RETURN_NEVER)