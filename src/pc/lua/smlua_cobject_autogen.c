...
#define LUA_CHARACTER_FIELD_COUNT 275
static struct LuaObjectField sCharacterFields[LUA_CHARACTER_FIELD_COUNT] = {
    ...
    { "capEnemyDecalGfx",                   LVT_STRING,  offsetof(struct Character, capEnemyDecalGfx),                   true, LOT_NONE                                   },
    { "capEnemyGfx",                        LVT_STRING,  offsetof(struct Character, capEnemyGfx),                        true, LOT_NONE                                   },
    ...
    { "modAudioSounds",                     LVT_S16,     offsetof(struct Character, modAudioSounds),                     true, LOT_NONE,      CHAR_SOUND_MAX, sizeof(s16) },
    { "modIndexForAudio",                   LVT_S16,     offsetof(struct Character, modIndexForAudio),                   true, LOT_NONE,      CHAR_SOUND_MAX, sizeof(s16) },
    { "moddedAnims",                        LVT_S16,     offsetof(struct Character, moddedAnims),                        true, LOT_NONE,      CHAR_ANIM_MAX,  sizeof(s16) },
...
static struct LuaObjectField sNetworkPlayerFields[LUA_NETWORK_PLAYER_FIELD_COUNT] = {
    ...
    { "modelIndex",             LVT_U16,     offsetof(struct NetworkPlayer, modelIndex),             true,  LOT_NONE          },
    ...
    { "overrideModelIndex",     LVT_U16,     offsetof(struct NetworkPlayer, overrideModelIndex),     false, LOT_NONE          },
...
static struct LuaObjectField sPresetPaletteFields[LUA_PRESET_PALETTE_FIELD_COUNT] = {
    { "active",  LVT_BOOL,    offsetof(struct PresetPalette, active),  false, LOT_NONE          },
    { "name",    LVT_STRING,  offsetof(struct PresetPalette, name),    false, LOT_NONE          },
    { "palette", LVT_COBJECT, offsetof(struct PresetPalette, palette), true,  LOT_PLAYERPALETTE },
};
...
struct LuaObjectTable sLuaObjectAutogenTable[LOT_AUTOGEN_MAX - LOT_AUTOGEN_MIN] = {
    ...
    { LOT_PRESETPALETTE,                sPresetPaletteFields,                LUA_PRESET_PALETTE_FIELD_COUNT                  },
...
const char *sLuaLotNames[] = {
	...
	[LOT_PRESETPALETTE] = "PresetPalette",
