...
struct GfxRenderingAPI {
    ...
    struct ShaderProgram *(*create_or_load_post_process_shader)(bool isPostProcessingPass);
    ...
    struct ShaderProgram *(*lookup_post_process_shader_using_index)(uint8_t framePassIndex);
