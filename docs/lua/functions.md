...
- characters.h
   - [character_get_first_allocated_index](functions-3.md#character_get_first_allocated_index)
   - [character_get_first_unallocated_index](functions-3.md#character_get_first_unallocated_index)
   - [character_get_first_allocated](functions-3.md#character_get_first_allocated)
   - [character_get_first_unallocated](functions-3.md#character_get_first_unallocated)
   - [get_allocated_character_from_index](functions-3.md#get_allocated_character_from_index)
   ...
   - [get_modded_character_anim_string](functions-3.md#get_modded_character_anim_string)
   - [update_character_anim_offset](functions-3.md#update_character_anim_offset)
   - [character_allocate](functions-3.md#character_allocate)
   - [character_deallocate](functions-3.md#character_deallocate)
   - [character_set_name](functions-3.md#character_set_name)
   - [character_set_cap_enemy_gfx_name](functions-3.md#character_set_cap_enemy_gfx_name)
   - [character_set_cap_enemy_decal_gfx_name](functions-3.md#character_set_cap_enemy_decal_gfx_name)
   - [character_set_hud_head_texture](functions-3.md#character_set_hud_head_texture)
   - [character_add_sound](functions-3.md#character_add_sound)
   - [character_remove_sounds](functions-3.md#character_remove_sounds)
   - [character_set_animation](functions-3.md#character_set_animation)
   - [character_remove_animation](functions-3.md#character_remove_animation)
...
- player_palette.h
   - [preset_palette_allocate](functions-6.md#preset_palette_allocate)
   - [preset_palette_set_name](functions-6.md#preset_palette_set_name)
   - [preset_palette_set_color_of_part](functions-6.md#preset_palette_set_color_of_part)
...
- smlua_anim_utils.h
   ...
   - [smlua_anim_util_animation_exists](functions-6.md#smlua_anim_util_animation_exists)
   - [smlua_anim_util_animation_exists_using_index](functions-6.md#smlua_anim_util_animation_exists_using_index)
   - [smlua_anim_util_get_index_from_name](functions-6.md#smlua_anim_util_get_index_from_name)
   - [smlua_anim_util_get_name_from_index](functions-6.md#smlua_anim_util_get_name_from_index)
