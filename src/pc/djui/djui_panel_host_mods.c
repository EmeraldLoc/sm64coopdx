    ...
    struct DjuiBase* body = djui_three_panel_get_body(panel);
    {
        ...
        if (gNetworkType == NT_NONE) {
            ...
            struct DjuiRect* rect2 = djui_rect_container_create(body, 45);
            {
                ...
                struct DjuiButton* button1 = djui_button_left_create(&rect2->base, DLANG(HOST_MODS, BROWSE_MODS), DJUI_BUTTON_STYLE_PRIMARY, djui_mod_website_open);
                struct DjuiButton* button2 = djui_button_right_create(&rect2->base, DLANG(HOST_MODS, OPEN_MOD_FOLDER), DJUI_BUTTON_STYLE_PRIMARY, djui_mod_folder_open);
