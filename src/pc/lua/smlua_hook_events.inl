...
SMLUA_EVENT_HOOK(HOOK_ON_POST_PROCESS_VERTEX_SHADER_CREATE, HOOK_RETURN_ON_OUTPUT_SET, u8 framePassIndex, OUTPUT const char **vertexShader)
SMLUA_EVENT_HOOK(HOOK_ON_POST_PROCESS_FRAGMENT_SHADER_CREATE, HOOK_RETURN_ON_OUTPUT_SET, u8 framePassIndex, OUTPUT const char **fragmentShader)
