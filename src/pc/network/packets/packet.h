...
void packet_init(struct Packet *packet, enum PacketType packetType, bool reliable,
                 enum PacketLevelMatchType levelAreaMustMatch);
...
// packet_sync_valid.c
void network_send_sync_valid(struct NetworkPlayer *toNp, s16 courseNum, s16 actNum, s16 levelNum,
                             s16 areaIndex, bool informServer);
...
void network_send_lua_sync_table(u8 toLocalIndex, u64 seq, u16 remoteIndex, u16 lntKeyCount,
                                 struct LSTNetworkType *lntKey, struct LSTNetworkType *lntValue);
