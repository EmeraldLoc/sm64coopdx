...
- behavior_actions.h
   ...
   - [bhv_bitfs_sinking_platform_init](functions-2.md#bhv_bitfs_sinking_platform_init)
   - [bhv_bitfs_sinking_platform_loop](functions-2.md#bhv_bitfs_sinking_platform_loop)
   - [bhv_bitfs_sinking_cage_platform_init](functions-2.md#bhv_bitfs_sinking_cage_platform_init)
   ...
   - [bhv_squishable_platform_init](functions-2.md#bhv_squishable_platform_init)
   ...
   - [bhv_jrb_sliding_box_init](functions-2.md#bhv_jrb_sliding_box_init)
   - [bhv_jrb_sliding_box_loop](functions-2.md#bhv_jrb_sliding_box_loop)
   - [bhv_ship_part_3_init](functions-2.md#bhv_ship_part_3_init)
